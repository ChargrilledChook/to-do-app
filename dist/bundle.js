...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0__);\n// Imports\n\nvar ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});\n// Module\n___CSS_LOADER_EXPORT___.push([module.id, \"/* This stylesheet is temporary, a bare minimum to help test functionality  */\\n\\nbody {\\n  min-height: 100vh;\\n  background-color: rgb(117, 173, 154);\\n  font-size: 1.8rem;\\n}\\n\\n.header {\\n  display: grid;\\n  place-items: center;\\n  min-height: 10rem;\\n  background-color: rgb(169, 226, 234);\\n}\\n\\n.main {\\n  margin: auto;\\n  display: grid;\\n  justify-content: center;\\n  max-width: 70ch;\\n  min-height: 80vh;\\n  border: 2px solid black;\\n  border-radius: 5px;\\n  background-color: rgb(247, 200, 171);\\n}\\n\\n.footer {\\n  min-height: 10rem;\\n  background-color: rgb(223, 211, 228);\\n}\\n\\n.add-todo {\\n  border-radius: 50%;\\n  height: 60px;\\n  width: 60px;\\n}\\n\\n.modal {\\n\\n  position: absolute;\\n  left: 50%;\\n  transform: translateX(-50%);\\n  top: 30%;\\n  display: none;\\n  place-items: center;\\n}\\n\\n.modal fieldset {\\n  background-color: rgb(209, 199, 199);\\n  border: 2px solid black;\\n  min-width: 40ch;\\n  display: flex;\\n  flex-direction: column ;\\n}\\n\\nfieldset input{\\n  margin-bottom: 2rem;\\n}\\n\\n\", \"\"]);\n// Exports\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);\n\n\n//# sourceURL=webpack://to-do-app/./src/styles/main.css?./node_modules/css-loader/dist/cjs.js");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var normalize_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! normalize.css */ \"./node_modules/normalize.css/normalize.css\");\n/* harmony import */ var _styles_defaults_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../styles/defaults.css */ \"./src/styles/defaults.css\");\n/* harmony import */ var _styles_main_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../styles/main.css */ \"./src/styles/main.css\");\n/* harmony import */ var _storageManager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./storageManager */ \"./src/js/storageManager.js\");\n/* harmony import */ var _todo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./todo */ \"./src/js/todo.js\");\n/* harmony import */ var _dataController__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dataController */ \"./src/js/dataController.js\");\n/* harmony import */ var _displayTodo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./displayTodo */ \"./src/js/displayTodo.js\");\n\n\n\n\n\n\n\n\nconsole.log(JSON.parse(localStorage.todoData));\n\nconst test = new _todo__WEBPACK_IMPORTED_MODULE_4__.Todo({\n  title: \"Groceries\",\n  description: \"Get some groceries\",\n  due: \"14/04/14\",\n});\n\nconsole.table(test);\n\nconst main = document.querySelector(\".main\");\n\nconst todoHTML = new _displayTodo__WEBPACK_IMPORTED_MODULE_6__.DisplayTodo(test);\nmain.append(todoHTML.card);\n\n// Add Todo Button\nconst addButton = document.querySelector(\".add-todo\");\naddButton.addEventListener(\"click\", () => {\n  const modal = document.querySelector(\".modal\");\n  if (modal.style.display === \"grid\") {\n    modal.style.display = \"none\";\n  } else {\n    modal.style.display = \"grid\";\n  }\n});\n\nconst submitButton = document.querySelector(\"#submit\");\nsubmitButton.addEventListener(\"click\", () => {\n  const name = document.querySelector(\"input[name='name']\").value;\n  const description = document.querySelector(\"input[name='description']\").value;\n  const due = document.querySelector(\"input[name='due-date']\").value;\n\n  const todo = new _todo__WEBPACK_IMPORTED_MODULE_4__.Todo(name, description, due);\n  const todoCard = new _displayTodo__WEBPACK_IMPORTED_MODULE_6__.DisplayTodo(todo);\n  main.append(todoCard.card);\n});\n\nconst data = (0,_storageManager__WEBPACK_IMPORTED_MODULE_3__.checkStorage)();\n\ndata.addTodo({ title: \"Milk\", project: \"Broceries\", priority: 1 });\n\nconsole.log(data);\n\nfunction renderTodos(list) {\n  list.forEach((todo) => main.append(new _displayTodo__WEBPACK_IMPORTED_MODULE_6__.DisplayTodo(todo).card));\n}\n\nrenderTodos(data.todoList);\n\nlocalStorage.setItem(\"todoData\", JSON.stringify(data));\n\n\n//# sourceURL=webpack://to-do-app/./src/js/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"checkStorage\": () => (/* binding */ checkStorage)\n/* harmony export */ });\n/* harmony import */ var _dataController__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dataController */ \"./src/js/dataController.js\");\n// class StorageManager {\n//   constructor() {\n//     this.data = checkStorage();\n//   }\n\n//   checkStorage() {\n//     if (!localStorage.getItem(\"todos\")) {\n//       const storage = {};\n//     } else {\n//       const storage = JSON.parse(localStorage.getItem(\"todos\"));\n//     }\n//     return storage;\n//   }\n// }\n\n\n\nfunction checkStorage() {\n  if (!localStorage.getItem(\"todoData\")) return new _dataController__WEBPACK_IMPORTED_MODULE_0__.DataController();\n\n  const storage = JSON.parse(localStorage.getItem(\"todoData\"));\n\n  const { idCounter, todoList } = storage;\n\n  return new _dataController__WEBPACK_IMPORTED_MODULE_0__.DataController(idCounter, todoList);\n}\n\n\n//# sourceURL=webpack://to-do-app/./src/js/storageManager.js?");
