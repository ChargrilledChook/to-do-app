...
var DataController = /*#__PURE__*/function () {
  ...
  _createClass(DataController, [{
    ...
    value: function addTodo(options) {
      ...
      var todo = new _todo_js__WEBPACK_IMPORTED_MODULE_0__.Todo(options);
      this.idCounter++;
      this.todoList.push(todo); // Return the thing we just added so we can use it straight away

      return this.todoList[this.todoList.length - 1];
    }
  }, {
    key: "listByProject",
    value: function listByProject(project) {
      return this.todoList.filter(function (entry) {
    ...
    value: function deleteTodo(id) {
      var index = this.todoList.findIndex(function (entry) {
        return entry.id === id;
      });
    ...
    key: "_listProjects",
    value: function _listProjects() {
      var result = this.todoList.reduce(function (acc, entry) {
...
var DisplayTodo = /*#__PURE__*/function () {
  function DisplayTodo(todo) {
    _classCallCheck(this, DisplayTodo);

    this.todo = todo;
  }

  _createClass(DisplayTodo, [{
    key: "card",
    get: function get() {
    ...
    value: function _createCard() {
      ...
      container.append(this._title(), this._dueDate(), this._deleteButton());
    ...
    value: function _formatDate() {
      try {
        var iso = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.default)(this.todo.dueDate);
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(iso, {
          addSuffix: true
        });
      } catch (error) {
        return "";
...
/* harmony export */ });
/* harmony import */ var _dataController_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dataController.js */ "./src/js/dataController.js");
...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/styles/defaults.css":
/*!***********************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/styles/defaults.css ***!
  \***********************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_defaults_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!./defaults.css */ "./node_modules/css-loader/dist/cjs.js!./src/styles/defaults.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_defaults_css__WEBPACK_IMPORTED_MODULE_1__.default, options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_defaults_css__WEBPACK_IMPORTED_MODULE_1__.default.locals || {});
...
/* harmony import */ var _storageManager_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./storageManager.js */ "./src/js/storageManager.js");
...
/* harmony import */ var _displayTodo_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./displayTodo.js */ "./src/js/displayTodo.js");
 ...
 // May be redundant if it's coming from the storage manager



var todoWindow = document.querySelector(".todo-window"); // This is no good. temp for now

var todoBox = todoWindow.querySelector(".todo-container");
var todoData = (0,_storageManager_js__WEBPACK_IMPORTED_MODULE_3__.checkStorage)();
renderTodos(todoBox, todoData.todoList); // Add Todo Button
